...
from src.routes import text_routes, image_routes, video_routes, youtube_routes #Импортируем все роуты
...
app.register_blueprint(text_routes.text_bp, url_prefix='/api/text')  #  <-- ДОЛЖНО БЫТЬ!
