...
from src.routes import text_routes, image_routes, video_routes, youtube_routes
...
app.register_blueprint(image_routes.image_bp, url_prefix='/api/image')  # <- Убедись, что имя ПРАВИЛЬНОЕ
